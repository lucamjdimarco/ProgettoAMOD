...
p = {(1, 1): 5, (1, 2): 6, (1, 3): 4, (2, 1): 8, (2, 2): 4, (2, 3): 3, (3, 1): 3, (3, 2): 1, (3, 3): 3, (4, 1): 7, (4, 2): 4, (4, 3): 8}
s = {1: 3, 2: 2, 3: 4}
pi = {1: 1, 2: 2, 3: 3, 4: 4}
...
for i in J:
    for j in J:
        init_constr[i, j] = model.addConstr(x[i, j] == 1 - x[i, j + 1] if j + 1 == pi[i] else x[i, j] == 0, "init[%s,%s]" % (i, j))
