        ...
        for j in range(1, len(seq)):
            if m == 1:
                if j == 1:
                    ...
                    Ctemp1[j, m] = Ctemp1[seq[j-1], m] + p[j, m]
            else:
                if j == 1:
                    Ctemp1[j, m] = Ctemp1[j, m-1] + p[j, m]
                else:
                    Ctemp1[j, m] = max(Ctemp1[seq[j-1], m], Ctemp1[j, m-1]) + p[j, m]
        ...
        for j in range(1, len(seq2)):
            if m == 1:
                if j == 1:
                    ...
                    Ctemp2[j, m] = Ctemp2[seq2[j-1], m] + p[j, m]
            else:
                if j == 1:
                    Ctemp2[j, m] = Ctemp2[j, m-1] + p[j, m]
                else:
                    Ctemp2[j, m] = max(Ctemp2[seq2[j-1], m], Ctemp2[j, m-1]) + p[j, m]
